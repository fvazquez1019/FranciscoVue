            ...
            <template #content>
              <div ref="chartContainer" class="scatter-chart">
                ...
                <div v-if="scatterData.points && scatterData.points.length === 0" class="no-data">
                  <Message severity="info" :closable="false">Sorry! No data available for the selected filters, Try again later. </Message>
                </div>
              </div>
            </template>
          </Card>
          ...
          <Card>
            ...
            <template #content>
              ...
              <div v-else class="no-selection">
                <Message severity="info" :closable="false">Click on a point on the graph to see track details</Message>
              </div>
            </template>
          </Card>
        </div>
            ...
            <template #content>
              <div class="grid">
                <div class="col-12 md:col-6">
                  ...
                  <p>Generally speaking, the more left the song is on the scatter plot the more dense it is, The more towards the right, the more spikier and bouncier it is.</p>
                </div>
                <div class="col-12 md:col-6">
                  <h4>Y-Axis: {{ getAxisLabel('y') }}</h4>
                  <p>The vertical position represents the song being more organic the lower it is on the graph The higher the song is on the grpah, the more mechanical and electronic it is.</p>
                </div>
                <div class="col-12">
