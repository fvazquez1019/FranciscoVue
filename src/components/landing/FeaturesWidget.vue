    ...
    <div id="features" class="py-6 px-6 lg:px-20 mt-8 mx-0 lg:mx-20">
        <div class="grid grid-cols-12 gap-4 justify-center">
            <div class="col-span-12 text-center mt-20 mb-6">
                ...
                <span class="text-muted-color text-2xl">Music says a lot about who we are, and now you can see it like never before. Our website will turn your Spotify listening history into stunning visual insights, uncovering the rhythms, genres, and habits that shape your sound. From your favorite tracks to hidden trends you didn’t even realize, explore your music journey in a whole new way, and find something you havent heard yet. Ready to discover your unique audio identity?</span>
            </div>
            ...
            <div class="col-span-12 md:col-span-12 lg:col-span-4 p-0 lg:pr-8 lg:pb-8 mt-6 lg:mt-0">
                <div style="height: 160px; padding: 2px; border-radius: 10px; background: linear-gradient(90deg, rgba(253, 228, 165, 0.2), rgba(187, 199, 205, 0.2)), linear-gradient(180deg, rgba(253, 228, 165, 0.2), rgba(187, 199, 205, 0.2))">
                    <div class="p-4 bg-surface-0 dark:bg-surface-900 h-full" style="border-radius: 8px">
                        ...
                        <h5 class="mb-2 text-surface-900 dark:text-surface-0">Spotify connected</h5>
                        <span class="text-surface-600 dark:text-surface-200">Instantly syncs your listening history and top tracks from Spotify.</span>
                    </div>
                </div>
            </div>
            ...
            <div class="col-span-12 md:col-span-12 lg:col-span-4 p-0 lg:pr-8 lg:pb-8 mt-6 lg:mt-0">
                <div style="height: 160px; padding: 2px; border-radius: 10px; background: linear-gradient(90deg, rgba(145, 226, 237, 0.2), rgba(251, 199, 145, 0.2)), linear-gradient(180deg, rgba(253, 228, 165, 0.2), rgba(172, 180, 223, 0.2))">
                    <div class="p-4 bg-surface-0 dark:bg-surface-900 h-full" style="border-radius: 8px">
                        ...
                        <h5 class="mb-2 text-surface-900 dark:text-surface-0">Genre Explorer</h5>
                        <span class="text-surface-600 dark:text-surface-200">Visualize your favorite music styles and discover new ones through interactive graphs.</span>
                    </div>
                </div>
            </div>
            ...
            <div class="col-span-12 md:col-span-12 lg:col-span-4 p-0 lg:pb-8 mt-6 lg:mt-0">
                <div style="height: 160px; padding: 2px; border-radius: 10px; background: linear-gradient(90deg, rgba(145, 226, 237, 0.2), rgba(172, 180, 223, 0.2)), linear-gradient(180deg, rgba(172, 180, 223, 0.2), rgba(246, 158, 188, 0.2))">
                    <div class="p-4 bg-surface-0 dark:bg-surface-900 h-full" style="border-radius: 8px">
                        ...
                        <div class="mt-6 mb-1 text-surface-900 dark:text-surface-0 text-xl font-semibold">Audio Insights</div>
                        <span class="text-surface-600 dark:text-surface-200">See your songs broken down by energy, danceability, tempo, and more.
